...
integrations: { dbEndpoint: "mongodb+srv://cluster.mongodb.net", apiWebhook: "https://www.google.com/search?q=https://api.redcommune.org/publish", cliToken: "rc_sec_8f92a" }
};
...
date: "Oct 24, 2026",
featured: true,
imageUrl: "https://www.google.com/search?q=https://images.unsplash.com/photo-1506869640319-ce1a4484c2eb%3Fauto%3Dformat%26fit%3Dcrop%26q%3D80%26w%3D1000"
},
{
id: 2,
...
return (
<ClerkProvider publishableKey={"pk_test_ZmFtb3VzLWdsaWRlci00OS5jbGVyay5hY2NvdW50cy5kZXYk"}>
<VanguardApp />
</ClerkProvider>
);
}
...
Workers of the world, unite!
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1">
    <header className="py-8 border-b-8 mb-8" style={{ borderColor: theme.text }}>
      ...
      <h1 className="text-6xl md:text-8xl lg:text-9xl font-black text-center uppercase tracking-tighter leading-none mb-4" style={{ color: theme.primary }}>
        {identity.siteName}
      </h1>
    ...
    <nav className="border-y-4 py-3 mb-12 flex flex-wrap justify-center gap-6 md:gap-12" style={{ borderColor: theme.text }}>
      {categories.map((cat, idx) => <span key={idx} className="uppercase font-bold tracking-widest text-sm hover:underline cursor-pointer">{cat}</span>)}
    </nav>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
      <main className="lg:col-span-8">
        <article className="mb-16">
          ...
          <div className="flex items-center gap-4 mb-6 text-sm font-bold uppercase tracking-wider" style={{ color: theme.primary }}>
            <span>{featuredArticle.category}</span><span>•</span><span>{featuredArticle.date}</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t-4 pt-8" style={{ borderColor: theme.text }}>
          {otherArticles.map(article => (
            <article key={article.id} className="group cursor-pointer">
              ...
              <div className="text-xs font-bold uppercase tracking-wider mb-3 opacity-70">{article.category}</div>
      ...
      <aside className="lg:col-span-4 space-y-12">
        <div className="p-6 border-4 shadow-[8px_8px_0px_0px]" style={{ borderColor: theme.text, shadowColor: theme.primary, backgroundColor: theme.background }}>
          <h3 className="text-2xl font-black uppercase mb-4 border-b-2 pb-2" style={{ borderColor: theme.text }}>The Program</h3>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 md:col-span-2">
                <label className="block text-xs font-mono text-gray-500 uppercase">The Program / About Text</label>
                <textarea 
